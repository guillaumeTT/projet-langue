...
<html>
    <head>
        <meta charset="utf-8">
        <title>Apprendre les bases</title>
        <link rel="stylesheet" type="text/css" href="globalPages.css">
        <link rel="stylesheet" type="text/css" href="niveauLangue.css">
        <script type= "text/javascript" src="manageContent.js"></script>
    </head>
    <body>
        <?php header_page(); ?>

        <h1 class="principal-title">Choisis le niveau de langue pour <?php echo $_REQUEST['langue']; ?></h1>
